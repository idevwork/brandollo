      ...
      <div class="row blue-bg-row blue-bg-row-desktop">
        <div class="col-xs-12 col-md-6">
          <div class="text-container">
            <p class="heading">
              <span class="bold">
                Get 4 months FREE access to the Brandollo marketing platform.
                <br>
                <br>Your free account includes:
              </span>
            </p>
            <ul class="small">
              <li>The Marketing Plan Builder</li>
              <li>Team Workflow Software</li>
              <li>Marketing Tutorials & Video Library</li>
              <li>Marketing Activity Tracking</li>
              <li>Customised Marketing Advice</li>
            </ul>
