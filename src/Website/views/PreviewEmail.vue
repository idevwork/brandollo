      ...
      <div class="row blue-bg-row blue-bg-row-desktop">
        <div class="col-xs-12 col-md-6">
          <div class="text-container">
            ...
            <p class="small">
              Brandollo is easy to use, helping design a custom marketing plan for your business.. Every marketing action that Brandollo recommends for your business is accompanied by both marketing tutorials and helpful workflow tools.
            </p>
