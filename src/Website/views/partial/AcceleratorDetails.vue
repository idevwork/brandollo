    ...
    <div class="content-container">
      <div class="row no-bg-row-1">
        <div class="col-xs-12 col-sm-6">
          <img :alt="content.imageAlt2" src="../../assets/gifs/Timeline-preview.gif">
        </div>
        <div class="col-xs-12 col-sm-6">
        ...
        <div class="col-xs-12 col-sm-6">
          <div class="text-container">
            ...
            <router-link
              ...
              to="/pricing"
              class="get-started-button"
            >{{content.button3}}</router-link>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6">
          <img :alt="content.imageAlt3" src="../../assets/gifs/Plan-complete.gif">
        </div>
      </div>
      ...
      <div class="row green-bg-row">
        <div class="col-xs-12 col-sm-6">
          <img :alt="content.imageAlt4" src="../../assets/gifs/Add-team.gif">
        </div>
        <div class="col-xs-12 col-sm-6">
          <div class="text-container">
      ...
      <div class="row yellow-bg-row yellow-bg-row-desktop">
        <div class="col-xs-12 col-sm-6">
          <div class="text-container">
            <p class="heading" v-html="content.title5"/>
            <p class="small" v-html="content.body5"/>
            <router-link
              title="Learn more"
              to="/pricing"
              class="get-started-button"
            >{{content.button5}}</router-link>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6">
          <img :alt="content.imageAlt5" src="../../assets/gifs/Plan-Picker.gif">
        </div>
      </div>
...
<script>
import content from "@/Website/copy/AcceleratorLanding";
