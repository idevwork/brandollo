      ...
      <div class="row blue-bg-row blue-bg-row-desktop">
        <div class="col-xs-12 col-md-6">
          <div class="text-container">
            <h1 class="heading" v-html="content.title1"></h1>
            <p class="small" v-html="content.body1"></p>
            <p class="small" v-html="content.list1"></p>
...
import ProductSections from "@/Website/views/partial/SmbDetails";
import SubscribeMixin from "@/Common/mixins/Subscribe";
import content from "@/Website/copy/SmallBusinessLanding"
...
export default {
  ...
  computed: {
    getStartedUrl() {
      return `/register/checkout?product=basic-subscription-3&email=${
        this.email
      }`;
    },
    videoLarge() {
